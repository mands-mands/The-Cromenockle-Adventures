...
class Level:
    def __init__(self, window):
        ...
        self.torre_colisao = pygame.Rect(30, 105, 30, 25)

        self.plataformas = [
            pygame.Rect(0, WIN_HEIGHT - 70, WIN_WIDTH, 70),  # chão
            pygame.Rect(450, 480, 110, 20),  # plataforma 1
            pygame.Rect(80, 400, 330, 20),  # plataforma 2
        ...
        self.papeis = [
            Paper(self.window, 24, 280),
            Paper(self.window, 760, 140),
            Paper(self.window, 730, 545),
        ]
    ...
    def desenhar_plataformas(self):
        for i, plat in enumerate(self.plataformas):
            if i == 0:  # imagem diferente no chao
                img = self.chao_img
            else:
                img = self.plat_img
            x = plat.x
